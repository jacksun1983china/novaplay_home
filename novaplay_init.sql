...
(2, 'YouMe Game 2026', 'youmegame2026', 'Global multi-language platform · 2026 Flagship', 'YouMe Game 2026 is our latest flagship platform built for global markets. It supports multiple languages and currencies, features a modern UI with smooth animations, and offers a comprehensive game library spanning Slots, Video Games, Fishing, and Poker.', '/uploads/halls/youme-game-2026.jpg', '["Slot","VideoGames","Fishing","Poker"]', 'https://www.youmegame.com', '', '["Global multi-language support","Multi-currency wallet","Modern animated UI","Comprehensive game library","Advanced player analytics","24/7 customer support integration"]', 1, 99, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
(3, '皇家永利', 'huang-jia-yong-li', 'Royal classic lobby · Mahjong & Jackpot', '皇家永利 (Huang Jia Yong Li) is a premium Chinese-style gaming platform featuring a grand royal aesthetic. It showcases Mahjong Ways, Fortune Rabbit, Dragon Tiger Luck, and a multi-Jackpot display, delivering an authentic and immersive experience for Chinese-speaking players.', '/uploads/halls/royal-yongli.jpg', '["Mahjong","Jackpot","Classic","Casino"]', 'https://hjyl888.one/', '', '["Royal Chinese visual theme","Multi-Jackpot live display","Mahjong Ways collection","Fortune Rabbit & Dragon Tiger","Localized Chinese interface","CDKey exchange system"]', 1, 98, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),
